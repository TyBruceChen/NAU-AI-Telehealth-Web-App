...
class text_modification():
    def __init__(self,replace_text_path = 'templates/index.html',replaced_element = 'Test Page'):
        self.replaced_element = replaced_element
        with open (replace_text_path,'r') as f:
            self.content = f.read()

    def replace_content(self,new_element):
        self.content = self.content.replace(self.replaced_element, new_element)
